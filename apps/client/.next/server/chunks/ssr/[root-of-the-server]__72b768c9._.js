...
"[project]/apps/client/src/hooks/useSimulacaoIndividual.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function useSimulacaoIndividual({ dadosOriginais, empresaSelecionada }) {
    ...
    const dadosEmpresa = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const metricasEmpresa = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const dadosEvolucaoEmpresa = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const dadosProdutividade = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return dadosRecalculados.flatMap((cliente)=>cliente.competencias.map((comp)=>({
                    competencia: comp.competencia,
                    lancamentos_por_hora: comp.tempo_gasto_sistema ? comp.lancamentos / (comp.tempo_gasto_sistema.split(':').map(Number).reduce((acc, val, i)=>acc + val * Math.pow(60, 2 - i), 0) / 3600) : 0,
                    custo_por_lancamento: comp.lancamentos > 0 ? comp.custo_operacional / comp.lancamentos : 0,
                    rentabilidade_por_hora: comp.tempo_gasto_sistema ? comp.rentabilidade_operacional / (comp.tempo_gasto_sistema.split(':').map(Number).reduce((acc, val, i)=>acc + val * Math.pow(60, 2 - i), 0) / 3600) : 0
                })));
    }, [
        dadosRecalculados
    ]);
    // Análise de tendências
    const analiseTendencias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const calcularTendencia = (dados, campo)=>{
            if (dados.length < 2) return 'Estável';
            const mediaAtual = dados.reduce((acc, item)=>acc + item[campo], 0) / dados.length;
            const mediaAnterior = anteriores3.length > 0 ? anteriores3.reduce((acc, item)=>acc + item[campo], 0) / anteriores3.length : mediaAtual;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$components$2f$modals$2f$ComposicaoSocietariaModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/client/src/components/modals/ComposicaoSocietariaModal.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$hooks$2f$useSimulacaoIndividual$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/client/src/hooks/useSimulacaoIndividual.ts [app-ssr] (ecmascript)");
...
function ClientesPage() {
    ...
    const [empresaSelecionada, setEmpresaSelecionada] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [escritorioSelecionado, setEscritorioSelecionado] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [searchTerm, setSearchTerm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    // Hook para simulação individual por cliente
    const { valorHora, setValorHora, dadosRecalculados, metricasEmpresa, dadosEvolucaoEmpresa, dadosProdutividade, analiseTendencias, resetValorHora, temEmpresaSelecionada } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$hooks$2f$useSimulacaoIndividual$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSimulacaoIndividual"])({
    ...
    const nomeEmpresaSelecionada = empresaSelecionada ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$lib$2f$mocks$2f$custo$2d$operacional$2e$mock$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockCustoOperacional"].find((emp)=>emp.id === empresaSelecionada)?.empresa || 'Empresa' : '';
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SimulacaoCusto, {
                valorHora: valorHora,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72b768c9._.js.map