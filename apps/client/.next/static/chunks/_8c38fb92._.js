...
"[project]/apps/client/src/components/simulacao/SimulacaoCusto.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function SimulacaoCusto(param) {
    let { valorHora, onValorHoraChange, metricas, onReset } = param;
    const formatCurrency = (value)=>{
        return new Intl.NumberFormat('pt-BR', {
            style: 'currency',
            currency: 'BRL'
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "font-semibold ".concat(metricas.totalFaturamento > 0 ? metricas.totalRentabilidade / metricas.totalFaturamento >= 0.1 ? 'text-green-600' : 'text-yellow-600' : 'text-gray-500'),
                                                    children: metricas.totalFaturamento > 0 ? "".concat((metricas.totalRentabilidade / metricas.totalFaturamento * 100).toFixed(1), "%") : 'N/A'
                                                }, void 0, false, {
                                                    fileName: "[project]/apps/client/src/components/simulacao/SimulacaoCusto.tsx",
                                                    lineNumber: 153,
                                                    columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "font-semibold ".concat(custoPorHora <= valorHora * 0.8 ? 'text-green-600' : custoPorHora <= valorHora * 1.2 ? 'text-yellow-600' : 'text-red-600'),
...
_c = SimulacaoCusto;
var _c;
__turbopack_context__.k.register(_c, "SimulacaoCusto");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/client/src/hooks/useValorHora.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function useValorHora(param) {
    let { dadosOriginais } = param;
    _s();
    ...
    const dadosRecalculados = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useValorHora.useMemo[dadosRecalculados]": ()=>{
            return dadosOriginais.map({
                "useValorHora.useMemo[dadosRecalculados]": (cliente)=>{
                    const competenciasRecalculadas = cliente.competencias.map({
                        "useValorHora.useMemo[dadosRecalculados].competenciasRecalculadas": (comp)=>{
                    ...
                    }["useValorHora.useMemo[dadosRecalculados].competenciasRecalculadas"]);
                    // Recalcular totais
                    const totalCustoOperacional = competenciasRecalculadas.reduce({
                        "useValorHora.useMemo[dadosRecalculados].totalCustoOperacional": (acc, comp)=>acc + comp.custo_operacional
                    }["useValorHora.useMemo[dadosRecalculados].totalCustoOperacional"], 0);
                    const totalRentabilidade = competenciasRecalculadas.reduce({
                        "useValorHora.useMemo[dadosRecalculados].totalRentabilidade": (acc, comp)=>acc + comp.rentabilidade_operacional
                    }["useValorHora.useMemo[dadosRecalculados].totalRentabilidade"], 0);
                    return {
                        ...cliente,
    ...
    const metricasAgregadas = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useValorHora.useMemo[metricasAgregadas]": ()=>{
            const totalCusto = dadosRecalculados.reduce({
                "useValorHora.useMemo[metricasAgregadas].totalCusto": (acc, cliente)=>acc + cliente.total_custo_operacional
            }["useValorHora.useMemo[metricasAgregadas].totalCusto"], 0);
            const totalRentabilidade = dadosRecalculados.reduce({
                "useValorHora.useMemo[metricasAgregadas].totalRentabilidade": (acc, cliente)=>acc + cliente.total_rentabilidade
            }["useValorHora.useMemo[metricasAgregadas].totalRentabilidade"], 0);
            const totalFaturamento = dadosRecalculados.reduce({
                "useValorHora.useMemo[metricasAgregadas].totalFaturamento": (acc, cliente)=>acc + cliente.total_faturamento
            }["useValorHora.useMemo[metricasAgregadas].totalFaturamento"], 0);
            // Calcular tempo total em horas
            const totalTempoHoras = dadosRecalculados.reduce({
                "useValorHora.useMemo[metricasAgregadas].totalTempoHoras": (acc, cliente)=>{
                    return acc + cliente.competencias.reduce({
                        "useValorHora.useMemo[metricasAgregadas].totalTempoHoras": (compAcc, comp)=>{
                            const [hours, minutes, seconds] = comp.tempo_gasto_sistema.split(':').map(Number);
                            return compAcc + hours + minutes / 60 + seconds / 3600;
                        }
                    }["useValorHora.useMemo[metricasAgregadas].totalTempoHoras"], 0);
                }
            }["useValorHora.useMemo[metricasAgregadas].totalTempoHoras"], 0);
            return {
                totalCusto,
    ...
    const dadosEvolucao = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useValorHora.useMemo[dadosEvolucao]": ()=>{
            const dadosAgregados = dadosRecalculados.flatMap({
                "useValorHora.useMemo[dadosEvolucao].dadosAgregados": (cliente)=>cliente.competencias.map({
                        "useValorHora.useMemo[dadosEvolucao].dadosAgregados": (comp)=>({
                    ...
                    }["useValorHora.useMemo[dadosEvolucao].dadosAgregados"])
            }["useValorHora.useMemo[dadosEvolucao].dadosAgregados"]);
            // Agrupar por competência
            const dadosAgrupados = dadosAgregados.reduce({
                "useValorHora.useMemo[dadosEvolucao].dadosAgrupados": (acc, item)=>{
                    const existing = acc.find({
                        "useValorHora.useMemo[dadosEvolucao].dadosAgrupados.existing": (x)=>x.name === item.name
                    }["useValorHora.useMemo[dadosEvolucao].dadosAgrupados.existing"]);
                    if (existing) {
            ...
            }["useValorHora.useMemo[dadosEvolucao].dadosAgrupados"], []);
            return dadosAgrupados;
        }
    }["useValorHora.useMemo[dadosEvolucao]"], [
        dadosRecalculados
    ]);
    const dadosResumo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useValorHora.useMemo[dadosResumo]": ()=>{
            return dadosRecalculados.map({
                "useValorHora.useMemo[dadosResumo]": (cliente)=>({
                        empresa: cliente.empresa,
...
_s(useValorHora, "1UcS3kdCcW5oiuaQlL6Mm6RvNXU=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/apps/client/src/lib/mocks/custo-operacional.mock.ts [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$components$2f$modals$2f$ComposicaoSocietariaModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/client/src/components/modals/ComposicaoSocietariaModal.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$components$2f$simulacao$2f$SimulacaoCusto$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/client/src/components/simulacao/SimulacaoCusto.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$hooks$2f$useValorHora$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/client/src/hooks/useValorHora.ts [app-client] (ecmascript)");
...
function ClientesPage() {
    ...
    const { valorHora, setValorHora, dadosRecalculados, metricasAgregadas, dadosEvolucao, dadosResumo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$hooks$2f$useValorHora$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useValorHora"])({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$components$2f$simulacao$2f$SimulacaoCusto$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimulacaoCusto"], {
                valorHora: valorHora,
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2f$src$2f$components$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2f$src$2f$components$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-2xl font-bold ".concat(metricasAgregadas.totalRentabilidade >= 0 ? 'text-green-600' : 'text-red-600'),
                                    children: [
                                        "R$ ",
...
_s(ClientesPage, "J686AjJ4rhYvr/M9G2cvUOv1tXQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$client$2f$src$2f$hooks$2f$useValorHora$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useValorHora"]
    ];
});
_c = ClientesPage;
var _c;
...
//# sourceMappingURL=_8c38fb92._.js.map